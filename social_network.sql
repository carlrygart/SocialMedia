...
CREATE TABLE friendship_listed_in (user_id_1 int(15) NOT NULL, user_id_2 int(15) NOT NULL, friend_list_id int(15) NOT NULL, PRIMARY KEY (user_id_1, user_id_2, friend_list_id), FOREIGN KEY (user_id_1, user_id_2) REFERENCES friendship(user_id_1, user_id_2) ON DELETE CASCADE ON UPDATE CASCADE, FOREIGN KEY (friend_list_id) REFERENCES friend_list(friend_list_id) ON DELETE CASCADE ON UPDATE CASCADE );
